...
output_dir = "/data/raw"
path_duas = os.path.join(output_dir, "reference_data/v1/tegucigalpa_reference_2024_v1.geojson")
...
if reference_available:
    ...
    print("Reference not available, skipping download and processing.")
    # output_reference = os.path.join(output_dir, f"reference_data/v1/{city}_reference_2024_v1.tif") #TODO: Raian to check this

# Download and pre-process the S2 image
s2_img = stac_api_new.process_sentinel2_stack(city, year=2025, basedir=output_dir)
...
if reference_available: #TODO: Raian to check this
